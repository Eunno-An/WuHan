...
exports.sendFollowerNotification = functions.database.ref('main/diagnosis')
    .onWrite(async (change, context) => {
       ...
       .ref('/main/lastDiag').once('value');  
        ...
        var message =  {
            notification: {
                title: '확진자 수가 '+(change.after.val() - change.before.val())+'명 증가된 '+change.after.val()+'명 입니다',
                //body: String(information[0].val())
                //body: '확진자 수가 '+changediagnosis[0].val()+'명 증가된 '+change.after.val()+'명 입니다'
            },
            topic: topic
        };
     ...
     .ref('/main/info_fatality').once('value');
        ...
        var message = {
            notification: {
                ...
                //body: String(changedfatality_information[0].val())
                //body: change.after.val()+'번째 사망자 발생'
            },
            topic: topic
        };
